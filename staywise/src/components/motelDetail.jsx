...
const MotelDetail = ({ match }) => {
  ...
  const fetchAverages = async () => {
    try {
      const response = await axios.get(`http://54.234.37.135:5000/reviews/averages/${id}`);
  ...
  const fetchReviews = async (page = 1) => {
    try {
      const response = await axios.get(`http://54.234.37.135:5000/reviews/${id}?page=${page}`);
  ...
  const logInteraction = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://54.234.37.135:5000/log-one-interaction', {
  ...
  const fetchPhotos = async () => {
    try {
      const response = await axios.get(`http://54.234.37.135:5000/reviews/photos/${id}`);
